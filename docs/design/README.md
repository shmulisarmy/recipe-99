...
- [Accessibility and motion](accessibility-motion.md) — WCAG target, focus, forms, responsive access, and reduced motion.
- [Implementation and acceptance](implementation-acceptance.md) — SolidJS boundaries and completion checklist.

The standalone [design examples](../design-examples/README.md) are visual checkpoints, not production code.

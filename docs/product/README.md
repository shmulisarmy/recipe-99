...
- [Redesign contract](redesign-contract.md) — current interface outline, capabilities that must remain, and permitted information-architecture opportunities.

Visual and interaction presentation is specified separately in [the design index](../design/README.md).
